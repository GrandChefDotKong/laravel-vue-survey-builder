...
import QuestionViewer from "../components/viewer/QuestionViewer.vue";
  ...
  const survey = computed(() => store.state.currentSurvey.survey);
...
<template>
  <div class="py-5 px-8">
    ...
    <form v-else @submit.prevent="submitSurvey" class="container mx-auto">
      ...
      <div v-if="surveyFinished" class="py-8 px-6 bg-emerald-400 text-white 
      w-[600px] mx-auto">
        <div class="text-xl mb-3 font-semibold ">
          Thank you for participating in this survey.
        </div>
        <button @click="submitAnotherResponse" type="button" class="inline-flex 
