  ...
  <page-component>
    ...
    >
      ...
      >
        ...
        <div
          class="text-8xl pb-4 font-semibold flex-1 flex items-center 
          justify-center"
        >
          {{ data.totalSurveys ? data.totalSurveys : '0' }}
        </div>
      </div>
      <div
        class="bg-white shadow-md p-3 text-center flex flex-col order-2 
        lg:order-4 animate-fade-in-down"
      ...
      >
        ...
        <div
          ...
          justify-center"
        >
          {{ data.totalAnswers ? data.totalAnswers : '0' }}
        </div>
      </div>
      <div
        class="row-span-2 animate-fade-in-down order-3 lg:order-1 bg-white 
        shadow-md p-4"
      >
        ...
        <div v-if="data.latestSurvey">
          ...
          <div v-if="data.latestSurvey.expire_date" class="flex justify-between text-sm mb-1">
            <div>Expire Date:</div>
          ...
          <div class="flex justify-between">
            <router-link
              :to="{ name: 'survey-view', params: { id: data.latestSurvey.id } }"
